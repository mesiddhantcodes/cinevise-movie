...
const Login = () => {
  ...
  const handleButtonClick = () => {
    ...
    if (isSignInForm) {
      const msg = checkValidData(null,email.current.value, password.current.value);
      setErrorMessage(msg);
      return;
    }
    else{
  ...
  return (
    <div>
      ...
      <form
        ...
        className=" text-white w-3/12 absolute p-12 bg-black my-36 mx-auto right-0 left-0 rounded-lg bg-opacity-80"
      >
